...
var jr = import_react.default.lazy(async () => {
  const { LiveAudioVisualizer: D } = await import("./react-audio-visualize.es-69216c73-TTJRLPSQ.js");
  return { default: D };
});
var pr = ({
  ...
  gr(
    ...
    const P = (await import("./index-1c988149-ADNORMRU.js").then((S) => S.i)).createFFmpeg({ log: false });
    await P.load();
